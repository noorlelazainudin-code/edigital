    ...
    <div className="p-4 md:p-8 space-y-6 pb-20 fade-in">
      ...
      <div className="border-b border-gray-700 pb-4">
        <div className="flex items-center gap-2 text-sm text-[#C9B458] font-mono mb-2">
           <span>KURIKULUM</span>
           <span>/</span>
           <span className="uppercase font-bold">PEPERIKSAAN</span>
        </div>
        <h2 className="text-3xl font-bold text-[#0B132B] font-montserrat uppercase">Peperiksaan Sekolah</h2>
        <p className="text-[#0B132B] mt-1 opacity-80">Pengurusan Jadual, Analisis, dan Pelaporan Peperiksaan Sesi 2026.</p>
      </div>

      {/* Tabs Navigation */}
      <div className="flex gap-2 overflow-x-auto pb-2 border-b border-gray-800 scrollbar-thin">
        {[
